...
<page  >
    <div style="position: relative;margin: 5px">
        ...
        <div style="position: absolute;left: 0px;top: 50px;width: 218px;text-transform: uppercase">
            ...
            <h4 style="font-size: 10px;padding: 0px;margin-top: -10px"><b>PISO:</b> <span style="font-weight: normal"><?=$PaseVisita['pv_piso']?></span></h4>
            <?php }?>
            
            <h4 style="font-size: 10px;padding: 0px;margin-top: -12px"><b>CAMA:</b> <span style="font-weight: normal"><?=$PaseVisita['pv_cama']?></span></h4>
            <h4 style="font-size: 10px;padding: 0px;margin-top: -12px"><b>SERVICIO:</b> <span style="font-weight: normal"><?=$PaseVisita['pv_servicio']?></span></h4>
            <h4 style="font-size: 10px;padding: 0px;margin-top: -12px"><b>HORARIO:</b> <span style="font-weight: normal"><?=$PaseVisita['pv_horario']?></span></h4>
...
<?php 
    ...
    $pdf->pdf->SetTitle('IMPRIMIR PASE DE VISITA A PISOS TEMP');
    $pdf->writeHTML($html);
    $pdf->pdf->IncludeJS("print(true);");
    $pdf->Output('IMPRIMIR PASE DE VISITA A PISOS TEMP.pdf');
?>