...
<page backtop="30mm" backbottom="7mm" backleft="10mm" backright="10mm">
    ...
    <div style="position: absolute;margin-top: 10px">
        ...
        <h4 style="text-align: center">RELACIÓN DE DEVOLUCIÓN AL ALMACEN DE MATERIALES DE OSTEOSÍNTESIS</h4>
        <table style="width: 100%" class="table">
            <tr>
                <th style="width: 70%;font-size: 10px;">USUARIO QUE GENERÓ RELACIÓN DE DEVOLUCIÓN</th>
                <th style="width: 30%;font-size: 10px;">FECHA Y HORA DE GENERACIÓN</th>
            </tr>
            <tr>
                <td style="font-size: 10px;;text-transform: uppercase"><?=$info['empleado_nombre']?> <?=$info['empleado_apellidos']?></td>
                <td style="font-size: 10px"><?=$info['rc_fecha_hora']?></td>
            </tr>
        </table><br><br>
        <table style="width: 100%" class="table">
            <thead>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="width: 25%;text-transform: uppercase;font-size: 9px;"><?=$value['elemento_titulo']?></td>
                    <td style="width: 20%;text-transform: uppercase;font-size: 9px;"><?=$value['rango_titulo']?></td>
                    <td style="width: 30%;text-transform: uppercase;font-size: 9px;">
                        <?=$value['inventario_id']?>
                    </td>
...
<?php 
    ...
    $pdf->pdf->SetTitle('RELACIÓN DE DEVOLUCIÓN A ALMACEN DE MATERIALES DE OSTEOSÍNTESIS');
    $pdf->Output('RELACIÓN DE DEVOLUCIÓN A ALMACEN DE MATERIALES DE OSTEOSÍNTESIS.pdf');
?>