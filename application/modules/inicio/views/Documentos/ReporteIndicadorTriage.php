    ...
    <page_header>
        ...
        <div style="width: 680px;margin-top: 45px;margin-left: 40px;position: absolute;">
            <table style="width: 100%" class="my_table">
                ...
                <tr>
                    <td colspan="3" >
                        <p style="text-transform: uppercase;font-size: 13px;font-weight: bold;margin-top: 30px;margin-bottom: 0px;text-align: center;text-transform: uppercase">REPORTE DE PRODUCTIVIDAD - <?=$this->UMAE_AREA?></p>
                    </td>
                </tr>
            </table>
    ...
    <table class="table">
        <thead>
            <tr>
                ...
                <th style="width: 20%">INGRESO ENFERMERÍA</th>
                <th style="width: 20%">INGRESO MÉDICO</th>
        ...
        <tr>
            ...
            <td><?=$value['ingreso_date_medico']!='' ? $value['ingreso_date_medico'].' '.$value['ingreso_time_medico']: 'SIN CLASIFICAR'?></td>
            <td><?=$value['ingreso_clasificacion']!='' ? $value['ingreso_clasificacion']: 'SIN CLASIFICAR'?></td>
        </tr>
        <?php }?>
    </table>
    <page_footer>
