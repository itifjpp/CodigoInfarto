...
<page>
    <page_header>
        <img src="assets/doc/sighFichaInternos.png" style="position: absolute;width: 100%;margin-top: -20px;margin-left: -5px;">
        <div style="position: absolute;top: 140px">
            ...
            <div style="position: absolute;margin-top: 492px;margin-left: 212px;font-size: 11px;"><?=$ua['eua_universidad']?></div>
            
            <div style="position: absolute;margin-top: 518px;margin-left: 195px;font-size: 12px"><?=$ua['eua_promedio']?></div>
            <div style="position: absolute;margin-top: 518px;margin-left:570px;font-size: 12px"><?=$ua['eua_vigencia']?></div>
            
            <?php foreach ($Documentos as $docs) {?>
            <div style="position: absolute;margin-top: 590px;margin-left:193px;font-size: 12px"><?=$docs['documento_tipo']=='ORDEN DE PRESENTACIÓN'? 'X':''?></div>
            <div style="position: absolute;margin-top: 590px;margin-left:470px;font-size: 12px"><?=$docs['documento_tipo']=='OFICIO DE DESIGNACIÓN DE PLAZA ESCUELA'? 'X':''?></div>
            <div style="position: absolute;margin-top: 590px;margin-left:655px;font-size: 12px"><?=$docs['documento_tipo']=='CALIFICACIONES'? 'X':''?></div>
            
            <div style="position: absolute;margin-top: 618px;margin-left:193px;font-size: 12px"><?=$docs['documento_tipo']=='ACTA DE NACIMIENTO'? 'X':''?></div>
            <div style="position: absolute;margin-top: 618px;margin-left:470px;font-size: 12px"><?=$docs['documento_tipo']=='4 FOTOS TAMAÑO INFANTIL A COLOR'? 'X':''?></div>
            <div style="position: absolute;margin-top: 618px;margin-left:655px;font-size: 12px"><?=$docs['documento_tipo']=='IFE'? 'X':''?></div>
            
            <div style="position: absolute;margin-top: 645px;margin-left:193px;font-size: 12px"><?=$docs['documento_tipo']=='HOJA DE ALTA INFOSAT'? 'X':''?></div>
            <div style="position: absolute;margin-top: 645px;margin-left:470px;font-size: 12px"><?=$docs['documento_tipo']=='CURP'? 'X':''?></div>
            <div style="position: absolute;margin-top: 645px;margin-left:304px;font-size: 12px"><?=$docs['documento_tipo']=='CARTILLA'? 'X':''?></div>
            <div style="position: absolute;margin-top: 645px;margin-left:655px;font-size: 12px"><?=$docs['documento_tipo']=='CURRICULUM VITAE'? 'X':''?></div>    
            <?php }?>
            <div style="position: absolute;margin-top: 721px;margin-left:135px;font-size: 12px"><b><?=$_GET['emp']?></b></div> 
...
<?php 
    ...
    $pdf->writeHTML($html);
    $pdf->pdf->SetTitle('FICHA DE INGRESO DE MÉDICO INTERNO');
    //$pdf->pdf->IncludeJS("print(true);");
    $pdf->Output('FICHA DE INGRESO DE MÉDICO INTERNO.pdf');
?>