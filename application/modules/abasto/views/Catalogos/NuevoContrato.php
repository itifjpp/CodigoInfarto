            ...
            <div class="box-inner padding">
                <div class="panel panel-default ">
                    <div class="panel-heading p teal-900 back-imss">
                        <span style="font-size: 15px;font-weight: 500;text-transform: uppercase"><b>NUEVO INSTRUMENTAl</b></span>
                    </div>
                    <div class="panel-body b-b b-light">
                        <form class="guardar-contrato">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="md-form-group">
                                        <label><b>NOMBRE DEL CONTRATO</b></label>
                                        <input class="form-control" name="contrato_nombre" required="" placeholder="NOMBRE DEL CONTRATO" value="<?=$DATOS['contrato_nombre']?>">   
                                    </div>
                                </div>
                                <div class="col-md-6">
