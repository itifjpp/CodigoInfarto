...
<div class="box-row">
    <div class="box-cell">
        <ol class="breadcrumb" style="margin-top: 0px;color:#2196F3">
            ...
            <li><a href="<?= base_url()?>Um/Encuestas/EncuestaPreguntasRespuetas?pregunta=<?=$_GET['pregunta']?>&enc=<?=$_GET['enc']?>">RESPUESTAS</a></li>
        </ol>
        <div class="box-inner col-md-12 col-centered" style="margin-top: 50px">
            <div class="panel panel-default ">
                <div class="panel-heading p teal-900 back-imss">
                    ...
                    <a href="#" md-ink-ripple="" class="md-btn md-fab m-b red waves-effect pull-right um-enc-preg-res-add-edit" data-id="0" data-icon="" data-respuesta="" data-pregunta="<?=$_GET['pregunta']?>" data-accion="add">
                                ...
                                <tbody>
                                    ...
                                    <tr id="<?=$value['respuesta_id']?>">
                                        ...
                                        <td class="text-center">
                                            <i class="fa fa-pencil icono-accion pointer um-enc-preg-res-add-edit" data-id="<?=$value['respuesta_id']?>" data-respuesta="<?=$value['respuesta_nombre']?>" data-icon="<?=$value['respuesta_icon']?>" data-pregunta="<?=$_GET['pregunta']?>" data-accion="edit"></i>&nbsp;
                                            <i class="fa fa-trash-o icono-accion pointer um-enc-preg-res-del" data-id="<?=$value['respuesta_id']?>"></i>
                                        </td>
                                    </tr>
                                    <?php } ?>
                                </tbody>
