...
<div class="box-row">
    <div class="box-cell">
        <ol class="breadcrumb" style="margin-top: 0px;color:#2196F3">
            ...
            <li><a href="<?= base_url()?>Um/Encuestas/Resultados?enc=<?=$_GET['enc']?>&tipo=Preguntas">PREGUNTAS</a></li>
            <?php }?>
        </ol> 
                                ...
                                <tbody>
                                    ...
                                    <tr id="<?=$value['encuesta_id']?>">
                                        ...
                                        <td class="text-center">
                                            <?php if(!isset($_GET['tipo'])){?>
                                            <a href="<?=  base_url()?>Um/Encuestas/Resultados?enc=<?=$value['encuesta_id']?>&tipo=Preguntas">
                                                <i class="fa fa-pencil-square-o tip i-20 color-imss" data-original-title="Preguntas"></i>
                                            </a>
                                            <?php }else{?>
                                            <a href="<?= base_url()?>Um/Encuestas/PreguntasGraficas?preg=<?=$value['pregunta_id']?>&tipo=Preguntas">
