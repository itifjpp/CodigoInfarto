            ...
            <div class="panel panel-default " style="margin-top: -20px">
                <div class="panel-heading p teal-900 back-imss">
                    <span style="font-size: 15px;font-weight: 500;text-align: center!important">
                        <strong>TRABAJO SOCIAL</strong><br>
                    </span>
                            ...
                            <table class="table table-hover table-bordered footable" data-page-size="10" data-filter="#filter_medico_choque" style="font-size: 13px">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php if($value['ts_status']=='Ingreso'){?>
                                            <span class="label orange">Ingreso</span>
                                            <?php }if($value['ts_status']=='Verificado'){?>
                                            <span class="label green">Verificado</span>
                                            <?php }?>
                                        </td>
                                        <td>
                                            <i class="fa fa-user-plus icono-accion pointer tip paciente-verificado" data-id="<?=$value['ts_id']?>" data-original-title="Agregar paciente como verificado"></i>
                                        </td>
                                    </tr>
                                    <?php }?>
                                </tbody>
