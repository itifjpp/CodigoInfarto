                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="panel panel-default ">
                                <input type="hidden" name="ObservacionTipo" value="Camas">
                                <div class="panel-body b-b b-light">
                                    ...
                                    <div class="row row-load hide">
                                        <div class="col-md-12 last_lista_no">
                                            <table class="table m-b-none ultima-cama-ocupada">
                                                <tbody>
                                                    <tr class=""></tr>
                                                </tbody>
                                            </table>
                                        ...
                                        <div class="col-md-12">
                                            <h1 class="text-center camas-ocupdas-no hide" style="margin-top: calc(15%);margin-bottom: calc(15%)">NO HAY LISTA DE PACIENTES </h1>
                                            <div class="row camas-ocupadas"></div>
                                        </div>
                                    </div>                          
                                </div>
