...
<div class="box-row">
    <div class="box-cell">
        <ol class="breadcrumb" style="margin-top: 0px">
            ...
            <li><a href="<?=  base_url()?>Sections/Codigos/Fase2?ci=<?=$_GET['ci']?>&f1=<?=$_GET['f1']?>">Fase 2</a></li>
            <li><a href="#">Fase 3</a></li>
        </ol>
        <div class="box-inner col-md-8 col-centered" style="margin-top: 45px">
            <div class="panel panel-default ">
                <div class="panel-heading p teal-900 back-imss">
                    <span style="font-size: 15px;font-weight: 500">CODIGOS FASE 3</span>
                    <a href="#" onclick="AbrirVista(base_url+'Sections/Codigos/AgregarFase3?f1=<?=$_GET['f1']?>&f2=<?=$_GET['f2']?>&f3=0&a=add',400,400)" class="md-btn md-fab m-b red waves-effect pull-right">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <table class="table table-bordered footable table-no-padding"  data-filter="#filter" data-page-size="10" data-limit-navigation="7">
                                <thead>
                                    <tr>
                                        <th style="width: 30%">FASE 2</th>
                                        <th style="width: 40%">FASE 3</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>                                       
                                        ...
                                        <td class="text-uppercase"><?=$value['ci_f3_fase']?></td>
                                        <td class="text-uppercase"><?=$value['ci_f3_tiempo']?></td> 
                                        <td>
                                            <a onclick="AbrirVista(base_url+'Sections/Codigos/AgregarFase3?f2=<?=$value['ci_f2_id']?>&f3=<?=$value['ci_f3_id']?>&a=edit',400,400)">
