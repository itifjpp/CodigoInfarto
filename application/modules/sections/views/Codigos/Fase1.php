        ...
        <div class="box-inner col-md-8 col-centered" style="margin-top: 45px">
            <div class="panel panel-default ">
                <div class="panel-heading p teal-900 back-imss">
                    <span style="font-size: 15px;font-weight: 500">CODIGOS FASE 1</span>
                    <a href="#" onclick="AbrirVista(base_url+'Sections/Codigos/AgregarFase1?ci=<?=$_GET['ci']?>&f1=0&a=add',400,400)" class="md-btn md-fab m-b red waves-effect pull-right">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <table class="table table-bordered footable table-no-padding"  data-filter="#filter" data-page-size="10" data-limit-navigation="7">
                                <thead>
                                    <tr>
                                        <th style="width: 30%">CODIGO INFARTO</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>                                       
                                        ...
                                        <td class="text-uppercase"><?=$value['ci_f1_tiempo']?></td> 
                                        <td>
                                            <a href="<?= base_url()?>Sections/Codigos/Fase2?ci=<?=$value['ci_id']?>&f1=<?=$value['ci_f1_id']?>">
                                                <i class="fa fa-share-square-o color-imss i-20 tip" data-original-title="Agregar Fases"></i>
                                            </a>&nbsp;
                                            <a onclick="AbrirVista(base_url+'Sections/Codigos/AgregarFase1?ci=<?=$value['ci_id']?>&f1=<?=$value['ci_f1_id']?>&a=edit',400,400)">
